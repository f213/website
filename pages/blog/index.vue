...
export default {
  ...
  head() {
    ...
    return {
      title:
        'Блог CTO про управление проектами, продуктами и командами. Раньше назывался «Блог ненужного менеджера»',
      titleTemplate: '%s',
      link,
      meta: [
        {
        ...
        },
        {
          name: 'description',
          content:
            'Личный блог Фёдора Борщёва. Здесь я делюсь профессиональными знаниями. Пишу про управление проектами и продуктами, а так же работу CTO в стартапе',
        },
      ],
    };
  },
