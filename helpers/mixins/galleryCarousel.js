  ...
  methods: {
    initCarouseles() {
      ...
      galleries.forEach((gallery) => {
        ...
        this.addBullets(gallery, slides, slides.length);
        this.toggleSlide(gallery, slides);
      });
    },
    ...
    addBullets(gallery, slides, count) {
      ...
      this.addGalleryEventListeners(gallery, slides, bullets);
    },
    ...
    addGalleryEventListeners(gallery, slides, bullets) {
      ...
      bullets.forEach((item, index) => {
        item.addEventListener('click', (evt) => {
          ...
          this.toggleSlide(gallery, slides, index);
        });
      });

      gallery.addEventListener('click', () => {
        this.toggleSlide(gallery, slides, activeSlideIndex);
